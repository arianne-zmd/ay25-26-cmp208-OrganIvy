...
fun ScreenshotsSubscreen(onNavigateToProfile: () -> Unit,
    ...
    if (state != null && state.screenshotsList.isNotEmpty()) {
        LazyGridScreenSSP(photoViewModel = photoViewModel, gameViewModel = gameViewModel, firebaseViewModel = firebaseViewModel)
    } else {
        Text(
            text = "Loading photos...",
...
@Composable
fun LazyGridScreenSSP(photoViewModel: PhotoViewModel, gameViewModel: GameViewModel, firebaseViewModel: FirebaseViewModel) {
