...
fun DownloadsSubscreen(onNavigateToProfile: () -> Unit,
    ...
    if (state != null && state.downloadsList.isNotEmpty()) {
        LazyGridScreenDP(photoViewModel = photoViewModel,  gameViewModel = gameViewModel, firebaseViewModel = firebaseViewModel)
    } else {
        Text(
            text = "Loading photos...",
...
@Composable
fun LazyGridScreenDP(photoViewModel: PhotoViewModel, gameViewModel: GameViewModel, firebaseViewModel: FirebaseViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        LazyVerticalGrid(
            ...
            val shownPhotos = state.downloadsList.filter{
